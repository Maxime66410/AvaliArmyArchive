...
Shader "Custom/LitTransparentWithDepth"
{
    Properties
    {
        ...
        [NoScaleOffset]
        _MetallicGlossMap ("Metallic(RED) Smoothness(ALPHA) Map", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            // Metallic and smoothness
            o.Metallic = tex2D (_MetallicGlossMap, IN.uv_MainTex).rgb;
            o.Metallic *= _Metallic;
            o.Smoothness = tex2D (_MetallicGlossMap, IN.uv_MainTex).a;
